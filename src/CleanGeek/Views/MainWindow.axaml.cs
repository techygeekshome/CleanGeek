...
public partial class MainWindow : Window
{
    public MainWindow()
    {
        ...
        {
            CleanGeek.Services.Log.Write("Could not wire the About buttons: " + ex);
        }
    }
    ...
    /// <summary>
    /// Asks GitHub whether there is a newer release. This is the only network call CleanGeek
